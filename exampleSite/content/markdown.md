...
``` markdown
  ![Semantic description of the image](/logo.png)
```
...
```
![Semantic description](/logo.png "Your title")*Your caption*
```
...
```
[![Semantic description](/logo.png.png "Your title")](http://jamstack.club)
```

**Output:**

[![Semantic description](/logo.png "Your title")](http://jamstack.club)
...
[image identifier]: /logo.png "Title"
```
